...
export default class extends React.Component<IProps, IState > {
    ...
    componentDidMount () {
        ...
        socket.emit("getConfig", "ssd:energysaver:getSSDInfos", (err: string, json: any) => {
            if (err) return;
            this.setState({
    ...
    render () {
        ...
        return (
            <div>
                ...
                <button className="btn" onClick={()=>{socket.emit("openMSConfig")}}>Autostart verwalten</button><br />

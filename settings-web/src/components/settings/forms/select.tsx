...
export default class extends React.Component<IProps, IStats> {
    ...
    onChange = () => {
        ...
        setTimeout(() => {
            socket.emit("setConfig", this.props.configID, this.state.selected, (err: boolean, value: string) => {
    ...
    componentDidMount () {
        ...
        socket.emit("getConfig", this.props.configID, (err: boolean, value: string) => {

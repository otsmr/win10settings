...
export default class extends React.Component<IProps, IState> {
    ...
    componentDidMount () {
        ...
        socket.emit("getConfig", "app:electron:isAdmin", (err: boolean, isAdmin: boolean) => {
            if (err) return;
        ...
        return (
            ...
            <div className="startpage noselect">
                ...
                <div className="getadmin" data-isadmin={this.state.isAdmin}>
                    <button onClick={()=>{ socket.emit("restartAsAdmin") }} className="btn-link">Als Administrator starten</button>
                </div>
            </div>

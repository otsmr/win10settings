...
export default class Toggle extends React.Component<IProps, IStats> {
    ...
    onChange = () => {
        ...
        setTimeout(() => {
            ...
            socket.post({id: this.props.configID, method: "set", body: { checked: this.state.checked} }, (err: boolean, value: boolean | string) => {
    ...
    componentDidMount () {
        ...
        socket.post({id: this.props.configID, method: "get", }, (err: boolean, value: boolean) => {

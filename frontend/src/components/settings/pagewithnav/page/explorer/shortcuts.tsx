...
export default class Shortcuts extends React.Component<IProps, IState > {
    ...
    onChange = (itemID: string, value: boolean) => {
        ...
        socket.post({id: configID, method: "set", body: { value, id } }, (itemType === "thispc") ? this.setThisPCItems : this.setProgramFolders);
    ...
    componentDidMount () {
        ...
        socket.post({id: "explorer:shortcuts:thispc", method: "get", }, this.setThisPCItems);
        socket.post({id: "explorer:shortcuts:programFolders", method: "get", }, this.setProgramFolders);
